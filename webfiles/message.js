...
class MessageManager {
    ...
    async sendMessage(message) {
        ...
        await this.query(this.dbcon, `insert into message (message, receiverid, senderid, date) values ('${message.message}', '${message.receiverid}', '${message.senderid}', now());insert into message (message, receiverid, senderid, date) values ('${message.message}', '${message.receiverid}', '${message.senderid}', now());`)
    }
